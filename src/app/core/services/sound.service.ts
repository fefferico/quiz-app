...
export class SoundService {
  ...
  private soundEffects: SoundEffect[] = [
    ...
    { key: 'streak1', path: 'assets/sounds/sound_AQS_firstblood.wav', volume: 0.7 },
    { key: 'streak2', path: 'assets/sounds/sound_AQS_unstoppable.wav', volume: 0.7 },
    { key: 'streak3', path: 'assets/sounds/sound_AQS_godlike.wav', volume: 0.7 },
    { key: 'done', path: 'assets/sounds/smb_stage_clear.wav', volume: 0.7 },
    { key: 'fail', path: 'assets/sounds/smb_gameover.wav', volume: 0.7 },
    { key: 'warning', path: 'assets/sounds/smb_warning.wav', volume: 0.7 },
    { key: 'roma', path: 'assets/musics/roma.mp3', volume: 1.0 },
    { key: 'lazio', path: 'assets/musics/lazio.mp3', volume: 1.0 },
